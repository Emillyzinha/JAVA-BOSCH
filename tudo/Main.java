...
import FrontEnd.AplicativoCompleto;

import java.io.IOException;

public class Main {
    public static void main(String[] args) throws IOException {
        new AplicativoCompleto();

//        Aplicativo aplicativo = new Aplicativo();
//
//        Restaurante restaurante = new Restaurante("TESTE1");
//        Restaurante restaurante2 = new Restaurante("TESTE2");
//
//        aplicativo.cadastrarRestaurante(restaurante);
//        aplicativo.cadastrarRestaurante(restaurante2);
//
//        System.out.println(aplicativo.getBdRestaurante());
//
//        System.out.println(aplicativo.nomeRestaurante());
